...
while not game.over:
    ...
    fence.draw()
    fence2.draw()
    game.drawText("Level 1", 10,10,f2)
...
while not game.over:
    ...
    fence.draw()
    fence2.draw()
    game.drawText("Level 2", 10,10,f2)
...
while not game.over:
    ...
    bk.draw()
    game.drawText("Crazy Car",240,50,f1)
    game.drawText("Thanks For Playing!",310,250,f)
    game.drawText("Press Space Bar to End The Game",235,200,f)
    car.draw()
    fence.draw()
    fence2.draw()
    if keys.Pressed[K_SPACE]:
